...
@test "roxctl-release netpol connectivity map generates connlist for input resources with admin network policies md format" {
  assert_file_exist "${test_data}/np-guard/anp_banp_demo/ns.yaml"
  assert_file_exist "${test_data}/np-guard/anp_banp_demo/policies.yaml"
  assert_file_exist "${test_data}/np-guard/anp_banp_demo/workloads.yaml"

  echo "Writing exposure report to ${ofile}" >&3
  run roxctl-release netpol connectivity map "${test_data}/np-guard/anp_banp_demo" --output-format=md
  assert_success
...
@test "roxctl-release netpol connectivity map generates connlist for input resources with admin network policies dot format" {
  assert_file_exist "${test_data}/np-guard/anp_banp_demo/ns.yaml"
  assert_file_exist "${test_data}/np-guard/anp_banp_demo/policies.yaml"
  assert_file_exist "${test_data}/np-guard/anp_banp_demo/workloads.yaml"

  echo "Writing exposure report to ${ofile}" >&3
  run roxctl-release netpol connectivity map "${test_data}/np-guard/anp_banp_demo" --output-format=dot
  assert_success
...
@test "roxctl-release netpol connectivity map generates connlist for input resources with admin network policies csv format" {
  assert_file_exist "${test_data}/np-guard/anp_banp_demo/ns.yaml"
  assert_file_exist "${test_data}/np-guard/anp_banp_demo/policies.yaml"
  assert_file_exist "${test_data}/np-guard/anp_banp_demo/workloads.yaml"

  echo "Writing exposure report to ${ofile}" >&3
  run roxctl-release netpol connectivity map "${test_data}/np-guard/anp_banp_demo" --output-format=csv
  assert_success
...
@test "roxctl-release netpol connectivity map generates connlist for input resources with admin network policies json format" {
  assert_file_exist "${test_data}/np-guard/anp_banp_demo/ns.yaml"
  assert_file_exist "${test_data}/np-guard/anp_banp_demo/policies.yaml"
  assert_file_exist "${test_data}/np-guard/anp_banp_demo/workloads.yaml"

  echo "Writing exposure report to ${ofile}" >&3
  run roxctl-release netpol connectivity map "${test_data}/np-guard/anp_banp_demo" --output-format=json
  assert_success
...
@test "roxctl-release netpol connectivity map generates exposure report for input resources with admin network policies md format" {
  assert_file_exist "${test_data}/np-guard/exposure_test_with_anp_banp/deployments.yaml"
  assert_file_exist "${test_data}/np-guard/exposure_test_with_anp_banp/policies.yaml"

  echo "Writing exposure report to ${ofile}" >&3
  run roxctl-release netpol connectivity map "${test_data}/np-guard/exposure_test_with_anp_banp" --exposure --output-format=md
  assert_success
...
@test "roxctl-release netpol connectivity map generates exposure report for input resources with admin network policies dot format" {
  assert_file_exist "${test_data}/np-guard/exposure_test_with_anp_banp/deployments.yaml"
  assert_file_exist "${test_data}/np-guard/exposure_test_with_anp_banp/policies.yaml"

  echo "Writing exposure report to ${ofile}" >&3
  run roxctl-release netpol connectivity map "${test_data}/np-guard/exposure_test_with_anp_banp" --exposure --output-format=dot
  assert_success
