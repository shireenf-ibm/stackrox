...
@test "roxctl-release netpol connectivity diff generates conns diff report between resources from directories with admin network policies md output" {
    dir1="${test_data}/np-guard/anp_banp_demo"
    dir2="${test_data}/np-guard/anp_banp_diff_demo"
    # assert files exist in dir1
    assert_file_exist "${dir1}/ns.yaml"
...
@test "roxctl-release netpol connectivity diff generates conns diff report between resources from directories with admin network policies csv output" {
    dir1="${test_data}/np-guard/anp_banp_demo"
    dir2="${test_data}/np-guard/anp_banp_diff_demo"
    # assert files exist in dir1
    assert_file_exist "${dir1}/ns.yaml"
