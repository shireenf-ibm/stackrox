...
func (cmd *Cmd) AddFlags(c *cobra.Command) *cobra.Command {
	...
	c.Flags().BoolVar(&cmd.explain, "explain", false, "Enhance the analysis of permitted connectivity with explainability information; supported only for txt format")
	return c
}
