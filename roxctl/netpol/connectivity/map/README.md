...
## About
The static network policy analyzer is a tool that analyzes Kubernetes network policies (i.e. NetworkPolicy, AdminNetworkPolicy and BaselineAdminNetworkPolicy objects).
